...
//       ShaderProgram("resources/Shaders/cubeMapVertex.glsl", "resources/Shaders/equirectangularToCubemapFragment.glsl");
...
//   glBindFramebuffer(GL_FRAMEBUFFER, m_captureFBO);
//   for (unsigned int i = 0; i < 6; ++i) {
//     glUniformMatrix4fv(m_equirectangularToCubemapShader.getUniformLocation("projection"), 1,
//                        GL_FALSE, glm::value_ptr(captureViews[i]));
