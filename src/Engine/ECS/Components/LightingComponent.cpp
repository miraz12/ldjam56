...
void LightingComponent::SetupPointLight(glm::vec3 color, float ambient, float diffuse,
...
void LightingComponent::SetupDirectionalLight(glm::vec3 color, float ambient, float diffuse,
                                              glm::vec3 dir) {
