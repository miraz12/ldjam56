...
Camera::Camera()
    : m_viewMatrix(1.0f), m_matrixNeedsUpdate(true), m_position{0.0f, 0.0f, 4.0f},
      m_front(0.0f, 0.0f, -1.0f), m_up(0.0f, 1.0f, 0.0f), m_zoom(1.0f), m_fov(45.0f), m_height(800),
      m_width(800) {}
...
void Camera::bindProjViewMatrix(unsigned int proj, unsigned int view) {
  if (m_matrixNeedsUpdate) {
    ...
    m_ProjectionMatrix = glm::perspectiveFov(m_fov, m_width, m_height, 0.01f, 10000.0f);
